...
public class Strategy implements DesignPattern {
    ...
    public String[] defaultClasses = {"Strategy", "Context","ConcreteStrategyA","ConcreteStrategyB","ConcreteStrategyC"};
    public String packageName = "com.BehavioralDP.strategy";
