...
public class Bridge implements DesignPattern {
    ...
    public String[] defaultClasses = {"Implementor", "ConcreteImplementorA","ConcreteImplementorB","Abstraction","RefinedAbstraction"};
    public String packageName = "com.StructuralDP.bridge";
