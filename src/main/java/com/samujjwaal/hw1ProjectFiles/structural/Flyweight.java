...
public class Flyweight implements DesignPattern {
    ...
    public String[] defaultClasses = {"Flyweight", "ConcreteFlyweight","UnsharedConcreteFlyweight","FlyweightFactory"};
    public String packageName = "com.StructuralDP.flyweight";
